...
|----|----------|-----------------|------|-----|
| S01 | **Tổng quan ngày** | Số hẹn hôm nay, visit mở, đơn chờ gửi NT | P0 | Ready |
| S02 | **Bệnh nhân** | Tìm SĐT/tên · tạo · sửa hồ sơ tối thiểu | P0 | Ready (`/clinic/patients` + customers) |
| S03 | **Bác sĩ / Provider** | Thêm BS, chuyên khoa, CCHN/license, active | P0 | Ready |
| S04 | **Lịch hẹn** | Lịch ngày · tạo · check-in · **đổi lịch** · hủy · no-show | P0 | Ready (week calendar = P1) |
| S05 | **Hàng đợi / Visit** | Mở visit từ hẹn hoặc walk-in · đang khám | P0 | Ready |
| S06 | **Chi tiết Visit** | Lý do khám · chẩn đoán · notes · đóng khám | P0 | Ready |
| S07 | **Kê đơn (trong Visit)** | Thêm dòng thuốc · liều · lưu draft · finalize · in/PDF | P0 | Ready |
| S08 | **Gửi nhà thuốc** | Chọn NT Connect active · gửi ready + đơn | P0 | Ready |
| S09 | **Lịch sử BN** | Visits + đơn trước đây | P1 | Ready (patient history) |
| S10 | **Connect (embedded)** | Referral inbox / booking từ NT · deep-link `/connect/*` OK | P1 | Ready (Connect UI) |
| S11 | **Báo cáo ngày** | Số khám, no-show, đơn gửi NT | P1 | Ready (day-summary) |
| S12 | **Cấu hình PK** | Chi nhánh, giờ làm việc đơn giản, mẫu in | P1 | Ready (`/clinic/settings` + PDF header) |
